                    ...
                    <div class="row">
                        <form action="<?= base_url('Dash/Dash/createContact') ?>" method="POST">
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <span class="text-danger text-sm">
                                        <?= isset($validation) ? display_error($validation, 'website'):'' ?>
                                    </span>
                                </div>
                            </div>
                            <div class="row mt-3">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" name="linkin" value="">
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-md-2">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-10">
                                    <input type="tel" class="form-control" name="number" value=""   pattern="[0-9()+- ]+">
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col">
