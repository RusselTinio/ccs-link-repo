                        ...
                        <div class="card" >
                            ...
                            <div class="row justify-content-center">
                                ...
                                <?php if (!$profileInfo['image']): ?>
                                    <img src="<?=base_url("upload/profile/no_profile.jpg")?>" id="previewImage" heigh="200" width="200">
                                <?php else: ?>
                                    <img src="<?=base_url("upload/profile/".$profileInfo['image'])?>" alt="<?= $profileInfo['image'] ?>"  id="previewImage" heigh="200" width="200">
                                <?php endif; ?>
                                </div>
                                <div class="row">
