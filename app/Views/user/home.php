                ...
                <div class="row align-items-center">
                    <div class="active-popular-post-carusel">
                        <div class="single-popular-post d-flex flex-row">
                            <div class="thumb">
                                <img class="img-fluid" src="landingPage/image/pic_1.png" alt="">
                                <a class="btns text-uppercase" href="newsandevents.html">view more</a>
                            </div>
                            <div class="details">
                        ...
                        <div class="single-popular-post d-flex flex-row">
                            <div class="thumb">
                                <img src="landingPage/image/pic_3.png" alt="">
                                <a class="btns text-uppercase" href="newsandevents.html">view more</a>
                            </div>
                            <div class="details">
                                <a href="#"><h4>The College of Computing Studies</h4></a>
                        ...
                        <div class="single-popular-post d-flex flex-row">
                            <div class="thumb">
                                <img src="landingPage/image/pic_4.png" alt="">
                                <a class="btns text-uppercase" href="newsandevents.html">view more</a>
                            </div>
                            <div class="details">
                                <a href="#"><h4>The College of Computing Studies</h4></a>
                        ...
                        <div class="single-popular-post d-flex flex-row">
                            <div class="thumb">
                                <img src="landingPage/image/pic_1.png" alt="">
                                <a class="btns text-uppercase" href="newsandevents.html">view more</a>
                            </div>
                            <div class="details">
                                <a href="#"><h4>The College of Computing Studies</h4></a>
                                ...
                                <div class="card swiper-slide">
                                    <div class="image-content">
                                        ...
                                        <div class="card-image">
                                            <img src="mentorshipPage/img/profile1.jpg" alt="" class="card-img">
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-content">
                                        ...
                                        <li> Degree : Software Engineering   </li>
                                        <li> Job : Tech Lead/ Senior Engineer II </li>
                                        </div>
                                        <div class="icons">
                                            <li>Contact Information: </li>
                                            <li><i class="fa fa-phone"> 0922-345-6789 </i></li>
                    ...
                    <div class="owl-carousel">
                        <div class="slider-card">
                            <div class="d-flex justify-content-center align-items-center mb-4">
                                <img src="landingPage/image/donation_1.jpg">
                            </div>
                        ...
                        <div class="slider-card">
                            <div class="d-flex justify-content-center align-items-center mb-4">
                                <img src="landingPage/image/donation_2.jpg">
                            </div>
                        ...
                        <div class="slider-card">
                            <div class="d-flex justify-content-center align-items-center mb-4">
                                <img src="landingPage/image/donation_3.jpg">
                            </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="active-popular-post-carusel">
                        <div class="single-popular-post d-flex flex-row">
                            <div class="thumb">
                                <img class="img-fluid" src="jobPage/img/p1.png" alt="">
                                <a class="btns text-uppercase" href="job.html">view job post</a>
                            </div>
                            <div class="details">
                        ...
                        <div class="single-popular-post d-flex flex-row">
                            <div class="thumb">
                                <img src="jobPage/img/p2.png" alt="">
                                <a class="btns text-uppercase" href="job.html">view job post</a>
                            </div>
                            <div class="details">
                                <a href="#"><h4>Creative Designer</h4></a>
                        ...
                        <div class="single-popular-post d-flex flex-row">
                            <div class="thumb">
                                <img src="jobPage/img/p1.png" alt="">
                                <a class="btns text-uppercase" href="job.html">view job post</a>
                            </div>
                            <div class="details">
                                <a href="#"><h4>Creative Designer</h4></a>
