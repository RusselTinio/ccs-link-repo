					  ...
					  <div class="sidebar">
						...
						<div class="sidebar-item recent-posts">
						  <div class="post-item clearfix">
							<img src="donationPage/imgs/blog1.jpg" alt="">
							<h4><a href="newsandevents.html">Nihil blanditiis at in nihil autem</a></h4>
							<time datetime="2020-01-01">Jan 1, 2020</time>
						  </div>
						  <div class="post-item clearfix">
							<img src="donationPage/imgs/blog2.jpg" alt="">
							<h4><a href="newsandevents.html">Quidem autem et impedit</a></h4>
							<time datetime="2020-01-01">Jan 1, 2020</time>
						  </div>
		  
						  <div class="post-item clearfix">
							<img src="donationPage/imgs/blog3.jpg" alt="">
							<h4><a href="newsandevents.html">Id quia et et ut maxime similique occaecati ut</a></h4>
							<time datetime="2020-01-01">Jan 1, 2020</time>
						  </div>
		  
						  <div class="post-item clearfix">
							<img src="donationPage/imgs/blog1.jpg" alt="">
							<h4><a href="newsandevents.html">Laborum corporis quo dara net para</a></h4>
							<time datetime="2020-01-01">Jan 1, 2020</time>
						  </div>
