...
<head>
	...
	<title>CCSLINK</title>
		...
		<link rel="stylesheet" href="style/landingPage/css/linearicons.css">
		<link rel="stylesheet" href="style/landingPage/css/font-awesome.min.css">
		<link rel="stylesheet" href="style/landingPage/css/bootstrap.css">
		<link rel="stylesheet" href="style/landingPage/css/magnific-popup.css">
		<link rel="stylesheet" href="style/landingPage/css/nice-select.css">					
		<link rel="stylesheet" href="style/landingPage/css/animate.min.css">
		<link rel="stylesheet" href="style/landingPage/css/owl.carousel.css">
		<link rel="stylesheet" href="style/landingPage/css/main.css">
		<link rel="stylesheet" href="style/landingPage/css/style.css">
		<link rel="stylesheet" type="text" href="style/landingPage/css/owl.carousel.min.css">
		<link rel="stylesheet" href="style/landingPage/landingpage.css"/>
	</head>
	<body>
                ...
                <div class="row align-items-center">
                    <div class="active-popular-post-carusel">
                        <div class="single-popular-post d-flex flex-row">
                            <div class="thumb">
                                <img class="img-fluid" src="style/landingPage/image/pic_1.png" alt="">
                                <a class="btns text-uppercase" href="loginform.html">view more</a>
                            </div>
                            <div class="details">
                                <a href="#"><h4>The College of Computing Studies</h4></a>
                                <p>
